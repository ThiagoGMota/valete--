...
export const Navbar = () => {
  ...
  return (
    <div className=' flex py-2 px-5 items-center justify-between md:px-32 md:py-4'>
      ...
      <div className='lg:w-1/6 lg:flex justify-end hidden '>
        <button className=' hidden md:flex bg-[#d11303] text-white font-bold hover:bg-red-700 transition-colors ease-linear w-[70,64px] h-[45,5px] px-[14px] py-[10px] rounded-[4px] cursor-pointer'>Login</button>
      </div>
